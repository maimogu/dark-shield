...
### 核心合约
- `contracts/0GIntegration.sol` - 清算预测核心合约
- `contracts/interfaces/I0GIntegration.sol` - 接口定义
...
### SDK 服务
- `contracts/scripts/0g-compute-service.js` - 风险评分计算
- `contracts/scripts/0g-da-service.js` - 风险评分存储
...
### 核心合约
- `contracts/HedgeStrategyManager.sol` - 策略管理
- `contracts/HedgeStrategyExecutor.sol` - 策略执行

### 脚本工具
- `contracts/scripts/hedge-strategy-recommender.js` - 策略推荐脚本
...
│   │   ├── HedgeStrategyManager.sol
│   │   └── HedgeStrategyExecutor.sol
│   ├── interfaces/             # 接口定义
│   ├── scripts/                # 部署和集成脚本
│   ├── test/                   # 测试文件
│   ├── deployments/            # 部署信息
